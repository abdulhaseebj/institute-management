...
export default function PersistentDrawerLeft({ screen, userImg, logout }) {
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="fixed" open={open}>
          <Toolbar>
            ...
            <Box sx={{ flexGrow: 1 }} /> {/* Added to push the logout button to the end */}
            <Box sx={{ ml: 2 }}> {/* Added margin for separation */}
